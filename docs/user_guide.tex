...
\begin{alltt}
\hspace	git clone https://bitbucket.org/bmpatena/analysis_pipeline
\end{alltt}
...
\end{description}
\end{subsection}
\begin{subsection}{Running Structural Analysis}
...
\
\begin{alltt}
analysis\_pipeline.sh  -func\_data <fmri\_4D.nii.gz>   -t1 <subjectID_struct_t1.nii.gz>  \backslash  \\
\hspace*{0.5in} -reg\_info <subjectID_struct_t1.struct_only> -design <spm\_design\_matrix.mat> \backslash  \\
\hspace*{0.5in} -spm\_contrast  <spm\_contrast\_file.m> -model\_name <name\_of\_model> \backslash   \\
\hspace*{0.5in} -output\_extension <analysis\_directory\_extension>  -motion -tr <TR> \backslash  \\
