...
\begin{chapter}{Pipeline Parameters}
		\begin{description}
			\item[-appendToAnalysis <directory> ] : Allows you to add new models/fc/ppi to previously processed data. Used in conjuction with other run run options such as -glm_only,-ppi_only,-rest_conn_only
		\end{description}
